        ...
        <div className="relative z-10 flex flex-col justify-between w-full p-12">
          ...
          <div className="max-w-md">
            ...
            <p className="text-background/70 leading-relaxed">
              Pick up right where you left off. Your study plans, progress, and goals are waiting for you.
            </p>
          </div>
          ...
          <div className="flex gap-8">
            <div>
              ...
              <p className="text-sm text-background/50">Active students</p>
            </div>
            <div>
              <p className="text-3xl font-bold">500k+</p>
              <p className="text-sm text-background/50">Study hours tracked</p>
            </div>
            <div>
              <p className="text-3xl font-bold">95%</p>
              <p className="text-sm text-background/50">Goal completion</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6 md:p-12">
        ...
        >
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <Button 
              type="submit" 
              className="w-full h-11 rounded-xl bg-primary hover:bg-primary/90 text-white mt-6"
              disabled={loading}
            >
              {loading ? (
                <>
